  ...
  const navItems = [
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
          <path d="M15.5 2a.5.5 0 0 1 .5.5v11a.5.5 0 0 1-.5.5H1a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5h14.5zm-13 1v10h12V3h-12z"/>
          <path d="M2 5h12v1H2V5zm0 3h12v1H2V8zm0 3h7v1H2v-1z"/>
        </svg>
      ),
    },
    {
