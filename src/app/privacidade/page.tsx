        ...
        <>
            ...
            <div className="container py-5" style={{ maxWidth: 760 }}>
                ...
                <section className="mb-4">
                    ...
                    <ul className="text-muted">
                        <li><strong>Acesso e portabilidade:</strong> exportar seus dados pessoais em formato JSON na seção <a href="/profile">Minha Conta → Privacidade e Dados</a> (requer login).</li>
