// Items loading skeleton — shown during navigation to "/items"
// Mirrors: 3-col header + filter card + table card (5 columns, 5 rows)
...
export default function ItemsLoading() {
  return (
    <section style={{ backgroundColor: "#F3F4F6" }} className="p-3">
      ...
      {/* Header: back btn | title | action btn */}
          ...
          <div className="table-responsive">
            <table className="table align-middle mb-0">
              <thead style={{ backgroundColor: "#F9FAFB" }}>
                <tr>
                  {["Item", "Categoria", "Próximo vencimento", "Status", ""].map((col) => (
              ...
              <tbody className="placeholder-glow">
                {[0, 1, 2, 3, 4].map((i) => (
                  <tr key={i}>
                    <td><span className="placeholder col-9 rounded" style={{ height: 14 }} /></td>
                    <td><span className="placeholder col-7 rounded" style={{ height: 14 }} /></td>
                    <td><span className="placeholder col-6 rounded" style={{ height: 14 }} /></td>
                    <td><span className="placeholder col-5 rounded-pill" style={{ height: 22 }} /></td>
                    <td className="text-end">
                      <span className="placeholder rounded" style={{ width: 56, height: 28 }} />
                    </td>
                  </tr>
                ))}
              </tbody>
